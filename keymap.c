...
[_QWERTY] = LAYOUT_ortho_4x12(
    ...
    KC_CAPS,  KC_LCTL,  KC_LGUI,  KC_LALT,  KC_SPC,  TT(_LOWER),  TT(_RAISE),  KC_SPC,     KC_LEFT,  KC_DOWN,  KC_UP,   KC_RGHT  \
),
...
[_RAISE] = LAYOUT_ortho_4x12( \
    ...
    KC_NO,   KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,   KC_ASTG,  KC_NO,    KC_HOME,  KC_PGDN,  KC_PGUP,  KC_END  \
),
};
